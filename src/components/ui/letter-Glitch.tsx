...
const LetterGlitch = ({
  glitchColors = ["#AD46FF", "#9C27B0", "#7E22CE"], // 💜 purple shades
  className = "",
  glitchSpeed = 50,
  ...
  const outerVignetteStyle: React.CSSProperties = {
    ...
    pointerEvents: "none",
    background:
      "radial-gradient(circle, rgba(173,70,255,0) 60%, rgba(173,70,255,0.9) 100%)",
  };
  ...
  const centerVignetteStyle: React.CSSProperties = {
    ...
    pointerEvents: "none",
    background:
      "radial-gradient(circle, rgba(173,70,255,0.6) 0%, rgba(173,70,255,0) 60%)",
  };
